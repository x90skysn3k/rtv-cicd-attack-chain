...
- `take-home-scripts/` — take-home-only persistence deployment, attendee-controlled TLS credential proof, one-edge traversal, fake-secret reads, and fixed-resource teardown.
